...
```bash
docker pull loomitz/burnrate:v0.1.6
```
...
La imagen `v0.1.6` fue revisada con Docker Scout y publicada con 0 vulnerabilidades detectadas en `linux/amd64` y `linux/arm64` al momento de la publicación.
